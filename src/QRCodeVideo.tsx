...
const CustomLaptop: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M20 16V7C20 5.89543 19.1046 5 18 5H6C4.89543 5 4 5.89543 4 7V16" stroke="currentColor" strokeWidth="0.4" strokeLinecap="round"/>
    <path d="M2 20H22" stroke="currentColor" strokeWidth="0.4" strokeLinecap="round"/>
    <path d="M4 16H20" stroke="currentColor" strokeWidth="0.4" strokeLinecap="round"/>
  </svg>
);
...
const exit = spring({
  ...
  const buttonClickColor = interpolate(
    frame,
    [170, 175, 180],
    [59, 37, 59],
    {
  ...
  return (
    <AbsoluteFill className="bg-gray-100 flex items-center justify-center">
      <div className="absolute inset-0 bg-cover bg-center" style={{backgroundImage: 'url(https://images.unsplash.com/photo-1496181133206-80ce9b88a853?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)'}} />
      ...
      <Sequence from={60} durationInFrames={240}>
        ...
        <div
          className="absolute right-[200px] transform translate-x-1/3"
          style={{ bottom: `${phonePosition}%` }}
        >
          ...
          <div className="absolute top-[10%] left-[28%] right-[28%] h-[68%] bg-gray-800  flex flex-col items-center justify-center">
            ...
            <div className="h-full flex flex-col justify-end">
              ...
              <div className="h-full flex flex-col justify-end gap-5 items-center"
                style={{ 
